    ...
    def send(self):
        ...
        while self.running:
            ...
            if message == '1':                           # V opačnom prípade sa text odošle
                ...
                #print(f"\033[34m[Simulovať chyby {'povolene', ak self.simulate_errors else 'zakazane'}]\033[0m")
...
if __name__ == "__main__":
    ...
    listen_port = 5001      # Port na počúvanie
    target_ip = '127.0.0.1' # IP adresa cieľového uzla
    target_port = 5000      # Port cieľového uzla
